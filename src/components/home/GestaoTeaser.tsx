    ...
    <Section className="relative overflow-hidden">
      ...
      <div className="grid items-center gap-16 lg:grid-cols-2 lg:gap-20">
        ...
        <div>
          ...
          <Reveal delay={0.1}>
            <h2 className="mt-4 text-4xl font-bold leading-[1.08] text-ink-900 sm:text-5xl">
        ...
        <Reveal direction="left">
          <div className="relative">
            ...
            <div className="glass-strong overflow-hidden rounded-[1.5rem] shadow-depth">
              {/* Barra do app */}
              <div className="flex items-center justify-between border-b border-ink-900/8 px-5 py-3.5">
                ...
                <div className="mb-5 grid grid-cols-3 gap-3">
                  {[
                    ...
                    >
                      ...
                      <p className="text-[0.7rem] text-ink-400">{k.l}</p>
                    </motion.div>
                  ))}
                </div>

                {/* Lista da frota */}
                <p className="mb-2.5 text-[0.65rem] font-semibold uppercase tracking-[0.16em] text-ink-400">
                  Frota
                </p>
